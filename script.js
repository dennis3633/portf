...
Fasten your seatbelts, my friend, and let's embark on this wild journey together!`;
let index = 0;
...
setInterval(typeMessage, 100); // Adjust the typing speed here (in milliseconds)
